...
<template>
  ...
  <!-- 大尺寸 -->
  <div class="q-px-xxxl gt-md" style="margin-left:20%; margin-right:20%; color: #5E8A4B;">
    <div class="row">
      <div class="col-12 q-py-xl text-center" :ratio="4 / 3">
  ...
  <!-- 中小尺寸 -->
  <div class="lt-lg" style="margin-left:5%; margin-right:5%; color: #5E8A4B;">
    <div class="row">
